    ...
    <div className="w-full flex flex justify-center">
      <div className="w-11/12 desktop:max-w-custom1300 mb-20">
        <div className="flex w-full justify-center">
          <h1 className="text-2xl font-gola text-[#FC4F00] mb-10 font-semibold">
            TESTIMONIAL
          </h1>
        </div>
        <div className="bg-[#FFE1CF]  flex items-center justify-center w-full h-full tablet:-pt-10 desktop:py-2 desktop:pt-2 desktop:pb-6 px-4">
          ...
          >
            <div className="w-full relative flex items-center justify-center">
              ...
              <ButtonBack
                ...
                className="absolute z-30 left-0 ml-8 focus:outline-none outline-none cursor-pointer"
                id="prev"
              >
                <img src="./left.svg" alt="Left Icon" />
              </ButtonBack>
              <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                <Slider>
                  <div
                    id="slider"
                    className="desktop:-mt-10 relative h-full flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700"
                  >
                    <Slide index={0}>
                      <div
                        style={{ left: "100px" }}
              ...
              <ButtonNext
                ...
                className="absolute z-30 right-0 mr-8 outline-none"
                id="next"
              >
                <img src="./right.svg" alt="Right Icon" />
              </ButtonNext>
            </div>
          </CarouselProvider>
            ...
            <div className="w-full relative flex items-center justify-center">
              ...
              <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                <Slider>
                  <div
                    id="slider"
                    className="tablet:-mt-10 h-full flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700"
                  >
                    <Slide index={0}>
          ...
          >
              ...
              <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                <Slider>
                  <div
                    id="slider"
                    className="mobile:-mt-10 h-full flex mobile:gap-2 items-center justify-start transition ease-out duration-700"
                  >
                    <Slide index={0}>
                      <div style={{ left: "40%" }} className="relative top-10">
                        <img
